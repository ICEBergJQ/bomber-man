...
export default function renderJoinScreen(gameState, sendToServer) {
    ...
    return createElement("div", {
        ...
        children: [
            ...
            createElement("input", {
                attrs: { type: "text", placeholder: "Enter your nickname", id: "nicknameInput" },
                events: { input: (e) => gameState.setState({ ...gameState.getState(), nickname: e.target.value }) },
            }),
                    ...
                    createElement("label", {
                        children: [
                            ...
                            createElement("input", {
                                ...
                                events: { change: (e) => gameState.setState({ ...gameState.getState(), isPlayer1: e.target.checked }) },
                            }),
                        ],
                    }),
                ],
